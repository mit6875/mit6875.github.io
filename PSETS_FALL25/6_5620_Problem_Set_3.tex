...
\textcolor{red}{Note: A previous version of this question had a typo an incorrectly defined the type of $H_k$ as $H_k: \{\{0,1\}^m \}^* \to \{0,1\}^n$. However in this part, we want the hash function to take as input strings of arbitrary length.}
